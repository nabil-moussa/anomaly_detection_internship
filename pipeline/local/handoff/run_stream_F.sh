#!/bin/bash
#SBATCH --job-name=mtad_stream_F
#SBATCH --output=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_F_%j.out
#SBATCH --error=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_F_%j.err
