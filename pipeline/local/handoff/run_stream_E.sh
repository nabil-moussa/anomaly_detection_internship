#!/bin/bash
#SBATCH --job-name=mtad_stream_E
#SBATCH --output=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_E_%j.out
#SBATCH --error=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_E_%j.err
