#!/bin/bash
#SBATCH --job-name=mtad_stream_F3
#SBATCH --output=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_F3_%j.out
#SBATCH --error=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_F3_%j.err
