#!/bin/bash
#SBATCH --job-name=mtad_stream_B
#SBATCH --output=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_B_%j.out
#SBATCH --error=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_B_%j.err
