#!/bin/bash
#SBATCH --job-name=mtad_stream_A1
#SBATCH --output=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_A1_%j.out
#SBATCH --error=/Work/Users/nmoussa/mtad-gat-pytorch/logs/mtad_stream_A1_%j.err
